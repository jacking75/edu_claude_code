...
- [(일어) Claude Code 라는 것은? AI 기동 개발 장점과 특징을 철저 해설](https://zenn.dev/tmasuyama1114/books/claude_code_basic/viewer/what-is-claude-code)   
...
- [클로드 코드 CLI: 터미널과 VS Code의 연결](https://codepointerko.substack.com/p/cli-vs-code)  

- [Claude Code용 윈도우 터미널 작업완료 알림 | GeekNews](https://news.hada.io/topic?id=25745)

- [(일어) Claude Code의 ENABLE\_TOOL\_SEARCH=1 동작을 이해하기 2026/01](https://zenn.dev/him0/articles/8b6c82e592e30b) 

- [(YOUTUBE) 이제 터미널에서 크롬까지 제어? Claude Code 2.10의 미친 신기능들](https://www.youtube.com/watch?v=43InaEM1hWc) 
